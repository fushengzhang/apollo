...
set apollo_config_db_url="jdbc:mysql://10.4.82.150:3306/ApolloConfigDB?characterEncoding=utf8"
set apollo_config_db_username="test"
set apollo_config_db_password="123456"

rem apollo portal db info
set apollo_portal_db_url="jdbc:mysql://10.4.82.150:3306/ApolloPortalDB?characterEncoding=utf8"
